...
<body>
    ...
    <main>
        <div id="topMain">
            ...
            <div id="button">
                <a href="../pac/korzina.html"><button id="but">Заказать</button></a>
            </div>
            
                <a href="../pac/pizza.html" id="pizza" class="topMenu" style="color: rgb(255,162,0);" >Пицца</a>
        ...
        <div id="catalogWrap">
            ...
            <div id="catalog">
                ...
                <div id="tovar1" class="tovar">
                    <div class="topStik">TOP</div>
                    <div class="img">
                    <img  src="../media/145-1459142_beef-pizza.png" width="45%" alt="">
                    </div>
                    <div class="title">Куриный жульен</div>
                    <div class="stikSize">
                         <button>20 <br> см</button>
                         <button>30 <br> см</button>
                         <button>40 <br> см</button>
                    </div>
                    <div class="sostav">Состав: пицца-соус, сыр Моцарелла, колбаса Пепперони, шампиньоны</div>
                ...
                <div id="tovar2" class="tovar">
                    <div class="topStik">TOP</div>
                    <div class="img">
                    <img  src="../media/2-23463_ham-and-pineapple-pizza-takumi-pineapple.png" width="45%" alt="">
                    </div>
                    <div class="title">Пепперони</div>
                    <div class="stikSize">
                         <button>20 <br> см</button>
                         <button>30 <br> см</button>
                         <button>40 <br> см</button>
                    </div>
                    <div class="sostav">Состав: соус Горчичный, лук красный, куриная грудка, сыр Моцарелла, чеснок, шампиньоны</div>
        ...
        <div id="catalog2">
            ...
            <div id="tovar3" class="tovar">
                <div class="img">
                <img  src="../media/pizza.png" width="45%" alt="">
                </div>
                <div class="title">С ананасом</div>
                <div class="stikSize">
                    <button>20 <br> см</button>
                    <button>30 <br> см</button>
                    <button>40 <br> см</button>
               </div>
                <div class="sostav">Состав: бекон, сырный соус, котлета говяжья, лук красный, салат, сыр</div>
            ...
            <div id="tovar4" class="tovar">
                <div class="topStik">NEW</div>
                <div class="img">
                <img  src="../media/pizza2.png" width="45%" alt="">
                </div>
                <div class="title">С оливками</div>
                <div class="stikSize">
                    <button>20 <br> см</button>
                    <button>30 <br> см</button>
                    <button>40 <br> см</button>
               </div>
                <div class="sostav">Состав: оливки, бекон, сырный соус, котлета говяжья, лук красный, салат, сыр, кетчуп, еще какой-то соус</div>
