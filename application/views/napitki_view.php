...
<body>
    ...
    <main>
        <div id="topMain">
            ...
            <a href="../pac/napitki.html" style="color: rgb(255,162,0);" id="napitki" class="topMenu">Напитки</a>
        ...
        <div id="catalogPac2">
            ...
            <div id="tovar33" class="tovar">
                ...
                <div class="img">
                <img  src="../media/88_881607_clipart_of_fruit_juice_canned_pencil_and_in_color_clipart.png" width="35%" alt="">
                </div>
                <div class="title">Морс Клубничный</div>
            ...
            <div id="tovar44" class="tovar">
                ...
                <div class="img">
                <img  src="../media/b0998a26210243.563531caac4f7.png" width="35%" alt="">
                </div>
                <div class="title">Пепси кола</div>
                <div class="sostav"></div>
            ...
            <div id="tovar55" class="tovar">
                ...
                <div class="title">Морс облепиховый</div>
                <div class="sostav"></div>
                <div class="price">130₽</div>
                <div class="butbut">
                    <button>В корзину</button>
