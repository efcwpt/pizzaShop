...
<body>
    ...
    <main>
        <div id="topMain">
            ...
            <a href="../pac/soys.html" id="soys" style="color: rgb(255,162,0);" class="topMenu">Соусы</a>
        ...
        <div id="catalogPac2">
            ...
            <div id="tovar33" class="tovar">
                <div class="topStik">NEW</div>
                <div class="img">
                <img  src="../media/6943_sous-heinz.png" width="35%" alt="">
                </div>
                <div class="title">Чили</div>
            ...
            <div id="tovar44" class="tovar">
                <div class="topStik">NEW</div>
                <div class="img">
                <img  src="../media/6943_sous-heinz.png" width="35%" alt="">
                </div>
                <div class="title">Острый чеснок</div>
                <div class="sostav">Состав: бекон, сырный соус, котлета говяжья, лук красный, салат, сыр, кетчуп, еще какой-то соус</div>
            ...
            <div id="tovar55" class="tovar">
                
                <div class="img">
                <img  src="../media/6943_sous-heinz.png" width="35%" alt="">
                </div>
                <div class="title">Клюквенный</div>
                <div class="sostav">Состав: бекон, сырный соус, котлета говяжья, лук красный, салат, сыр, кетчуп, еще какой-то соус</div>
                <div class="price">130₽</div>
                <div class="butbut">
                    <button>В корзину</button>
            ...
            <div id="tovar66" class="tovar">
                
                <div class="img">
                <img  src="../media/6943_sous-heinz.png" width="35%" alt="">
                </div>
                <div class="title">Сладкий</div>
                <div class="sostav">Состав: бекон, сырный соус, котлета говяжья, лук красный, салат, сыр, кетчуп, еще какой-то соус</div>
                <div class="price">130₽</div>
                <div class="butbut">
                    <button>В корзину</button>
