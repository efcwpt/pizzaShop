...
<body>
    ...
    <main>
        <div id="topMain">
            ...
            <a href="../pac/zakuski.html" style="color: rgb(255,162,0);" id="zakuski" class="topMenu">Закуски</a>
        ...
        <div id="catalogPac2">
            ...
            <div id="tovar33" class="tovar">
                ...
                <div class="img">
                <img  src="../media/plate-land-3.png" width="45%" alt="">
                </div>
                <div class="title">Сет "Японский"</div>
            ...
            <div id="tovar44" class="tovar">
                ...
                <div class="sostav">Состав: Курица, грунки, сыр, листья салата, соус</div>
            ...
            <div id="tovar55" class="tovar">
                ...
                <div class="title">Другой салат</div>
                <div class="sostav">Состав: Курица, гренки, какой-то соус и что-то еще</div>
                <div class="price">130₽</div>
                <div class="butbut">
                    <button>В корзину</button>
                </div>
